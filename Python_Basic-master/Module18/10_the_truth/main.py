...
input_text = 'vujgvmCfb tj ufscfu ouib z/vhm jdjuFyqm jt fscfuu uibo jdju/jnqm fTjnqm tj scfuuf ibou fy/dpnqm ' \
...
print(encrypted(input_text, 1))
print('original Text link\t', 'https://www.python.org/dev/peps/pep-0020/')
print('\n')
print("""
